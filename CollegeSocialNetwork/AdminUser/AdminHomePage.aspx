<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHomePage.aspx.cs" Inherits="CollegeSocialNetwork.AdminUser.AdminHomePage" %>
            ...
            <div class="nav" style="width:100%;">
                <ul class="main-menu" style="width:auto;">
                    ...
                    <li>PROFILE
                            ...
                            <li><a href="../Profile/AddUser.aspx" style="color:white; text-decoration:none;" >Add User</a></li>
                            <li><a href="../Profile/ViewUser.aspx" style="color:white; text-decoration:none;" >View User</a></li>                                
                            <%--<li><a href="#" style="color:white; text-decoration:none;" >Add Student Profile</a></li>
                            <li><a href="#" style="color:white; text-decoration:none;" >View Student Profile</a></li>--%>
                        </ul>
                    </li>
                    <li>SETTING
                        <ul class="sub-menu">
