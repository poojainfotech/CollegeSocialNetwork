<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCourse.aspx.cs" Inherits="CollegeSocialNetwork.Course.ViewCourse" %>
              ...
              <table style="height:auto; width:100%;margin:0px; padding:0px; border-collapse:collapse;">
                  ...
                  <tr>
                      <td colspan="10" style="width:10%;">                         
                          <b style="color:orangered; text-align:left; font-family:fantasy; font-size:20px;">List Of Course</b>
                      </td>
                  </tr>
                  <tr>
                  ...
                  <% if (ViewCourseData != null && ViewCourseData.Rows.Count > 0) %>
                  <% { %>
                  <%    for (int i = 0; i < ViewCourseData.Rows.Count ;i++) %>
                  <%    { %>
                             <% if (i % 2 == 0) %>
                             <% { %>
                                 <tr>
                                     ...
                                     <td style="width:3%;  text-align:right; background-color:#80dfff; border-bottom-right-radius:10px; border-top-left-radius:10px;">
                                        <%:i+1 %>&nbsp;&nbsp;
                                     </td>
                                     <td colspan="2" style="width:10%;color:orangered;background-color:#b3ecff; text-align:left; border-bottom-right-radius:10px; border-top-left-radius:10px;">                                  
                                        <b><%:ViewCourseData.Rows[i]["CourseName"] %></b>
                                     </td>
                             ...
                             <% { %>
                                 <tr>
                                     ...
                                     <td style="width:3%;  text-align:right; background-color:#ff99cc; border-bottom-right-radius:10px; border-top-left-radius:10px;">
                                         <%:i+1 %>&nbsp;&nbsp;
                                     </td>
                                     <td colspan="2" style="width:10%;color:orangered;background-color:#ffcce6; text-align:left; border-bottom-right-radius:10px; border-top-left-radius:10px;">
                                         <b><%:ViewCourseData.Rows[i]["CourseName"] %></b>
                                     </td>
                                     <td style="width:10%;">
                  ...
                  <% { %>
                       <tr>
                         ...
                         <td colspan="6" style="width:10%;color:orangered;background-color:#f2ffe6; text-align:left;">
                            Course not added.
                         </td>
