<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteCourse.aspx.cs" Inherits="CollegeSocialNetwork.Course.DeleteCourse" %>
              ...
              <table style="height:auto; width:100%;margin:0px; padding:0px; border-collapse:collapse;">
                  ...
                  <tr>
                      <td colspan="10" style="width:10%;">                         
                          <b style="color:orangered; text-align:left; font-family:fantasy; font-size:20px;">Delete Course</b>
                      </td>
                  </tr>
                  <tr>
                 ...
                 <tr>
                      ...
                      <td style="width:10%;color:orangered; text-align:left;">
                          <asp:Button ID="btnAddCourse" runat="server" Text="Delete Course" OnClick="btnDeleteCourse_Click" CssClass="button" />                          
                      </td>
