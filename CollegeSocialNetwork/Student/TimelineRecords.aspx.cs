...
{
    public partial class TimelineRecords : System.Web.UI.Page
    {
        public DataTable ViewStudentTimelineRecords = null;
        public void Page_Load(object sender, EventArgs e)
        {
            DataBaseUtility dataBaseUtility = new DataBaseUtility();
            DataTable dt = dataBaseUtility.GetDataSet("sp_ViewStudentTimelineRecords", "ViewStudentTimelineRecords", null);

            if (dt.Rows.Count > 0)
            {
                this.ViewStudentTimelineRecords = dt;
            }
        }
