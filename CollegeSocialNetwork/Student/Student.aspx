<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="CollegeSocialNetwork.Student.StudentProfile" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
          <div style="height:auto; color:white; width:90%; margin:auto;">
            ...
            <div class="nav" style="width:auto; width:100%;">
                <ul class="main-menu" style="width:auto;">
                    ...
                    <li>QUIZ
                        <ul class="sub-menu">
                            <li><a href="../Quiz/TestByStudent.aspx" style="color:white; text-decoration:none;" >Test</a></li>
                            <li><a href="../Quiz/ViewQuizResult.aspx" style="color:white; text-decoration:none;" >Test Result</a></li>
                        </ul>
                    </li>
                    <li>PROFILE
                            <ul class="sub-menu">
